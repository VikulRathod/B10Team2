<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDriver.aspx.cs" Inherits="_1_Authentication.AddDriver" %>
    ...
    <div>
        ...
        <tr>
            ...
            <td>
                ...
                <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server"
                     ConnectionString="<%$ ConnectionStrings:CARConnectionString %>"
                     OnSelecting="SqlDataSource1_Selecting" SelectCommand="SELECT * FROM [AddDriver]"></asp:SqlDataSource>--%>
        ...
        <tr>
            <td class="style5">
                ...
                Full Address</td>
            <td>
                <asp:TextBox ID="TxtDaddress" runat="server" Height="69px" TextMode="MultiLine" 
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDPhone" runat="server"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtDPhone" ErrorMessage="This information is required"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style5">
                Password</td>
            <td>
                <asp:TextBox ID="txtDpass" runat="server" TextMode="Password"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="txtDpass" ErrorMessage="This information is required"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style5">
                Confirm Password</td>
            <td>
                <asp:TextBox ID="txtDCpass" runat="server" TextMode="Password"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ControlToValidate="txtDCpass" ErrorMessage="This information is required"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style5">
        ...
        <tr>
            ...
            <td>
                ...
                <%--<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CARConnectionString %>" OnSelecting="SqlDataSource2_Selecting" SelectCommand="SELECT * FROM [addtype]"></asp:SqlDataSource>--%>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td class="style5">
                Car Name</td>
            <td>
                <asp:TextBox ID="txtDcarname" runat="server"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            <td class="style5">
                Car Number</td>
            <td>
                <asp:TextBox ID="txtDCarNumber" runat="server"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
